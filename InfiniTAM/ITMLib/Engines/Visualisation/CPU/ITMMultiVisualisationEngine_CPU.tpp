...
#pragma omp parallel for
		...
		for (int locId = 0; locId < imgSize.x*imgSize.y; ++locId)
		{
			...
			castRay<VD, ID, false>(pointsRay[locId], NULL, x, y, &renderState->voxelData_host, &renderState->indexData_host, invM, invProjParams, oneOverVoxelSize, mu, minmaximg[locId2], NULL, NULL);
		}
	}
